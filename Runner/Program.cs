...
internal static class Program
{
    ...
    private static void Main()
    {
        var entries = new List<MenuEntry>
        {
            ...
            new(7, "Proxy", "Control access to an expensive or sensitive object via a stand-in with the same interface.", Patterns.Proxy.Solution.Reference.Demo),
            new(8, "Composite", "Treat individual objects and groups of objects through the same interface.", Patterns.Composite.Solution.Reference.Demo),
            new(9, "Observer", "Notify a dynamic set of interested parties whenever an object's state changes.", Patterns.Observer.Solution.Reference.Demo),
